    ...
    <section className="bg-[#001224] text-white py-16 px-6 text-center">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mb-8 w-[80%] py-4 mx-auto text-[26px] font-hk-grotesk font-normal text-gray-300">
          Save time, cover your investment, and unlock new opportunities with
          NyquistAI. Experience unprecedented efficiency and ROI. Transform your
          data into insights today.
        </p>
